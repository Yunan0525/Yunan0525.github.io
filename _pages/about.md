---
permalink: /
title: "Welcome to Yunan's personal website"
author_profile: true
redirect_from: 
  - /about/
  - /about.html
...
<img src="/images/moments/yunan.jpg" alt="Yunan Hu photo" width="260" style="border-radius: 12px; float: right; margin-left: 25px; margin-bottom: 10px;">
...
- Molecular biology (PCR, cloning, qPCR, library prep)
- Computational biology & bioinformatics (metagenomics, RNA-seq, protein structure)
- Data visualization, statistics, and reproducible research

---

# 🧪 Research Interests

I currently work on topics related to microbial ecology, gut immunity, and microbiome engineering:

- **Gut microbiome & host interaction** — how microbes influence immunity, mucus layers, and pathogen resistance  
- **Microbiome-based therapeutics** — engineered microbial consortia, GOS/hGOS prebiotics, and FMT 
- **C. difficile infection** — investigated prevention strategies
- **Mucin-degrading bacteria** — mucus-degraders and their metabolic interactions with pathogens  
