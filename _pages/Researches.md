...
.image-card img {
  max-width:300px;   /* adjust if too small */
  width: 70%;
  border-radius: 8px;
  margin-top: 5px;
}
...
<div id="mucus" class="project-section" markdown="1">
  ...
  <p>
  The colonic mucus layer forms a critical barrier that separates microbes from the epithelium. Aging reduces mucus thickness and alters glycan composition, contributing to inflammation and pathogen vulnerability.
  </p>
